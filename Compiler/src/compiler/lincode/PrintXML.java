...
public class PrintXML implements Visitor {
	...
	public void visit(AbsArrType acceptor) {
		...
		{ SemType type = TypeResolver.getType(acceptor); if (type != null) type.toXML(xml); }
		xml.println("</absnode>");
	}
	...
	public void visit(AbsAssignStmt acceptor) {
		...
		{ SemType type = TypeResolver.getType(acceptor); if (type != null) type.toXML(xml); }
		{ ImCode code = compiler.imcode.CodeGenerator.getCode(acceptor); if (code != null) code.toXML(xml); }
		{ ImCode code = compiler.imcode.CodeGenerator.getCode(acceptor); if (code != null && code.linearCode != null) code.linearCode.toXML(xml); }
		xml.println("</absnode>");
	}
	...
	public void visit(AbsAtomExpr acceptor) {
		...
		if (acceptor.expr != null) acceptor.expr.toXML(xml);
		{
			...
			if (value != null) xml.println("<semintvalue value=\"" + value + "\"/>");
		}
		{ SemType type = TypeResolver.getType(acceptor); if (type != null) type.toXML(xml); }
		{ ImCode code = compiler.imcode.CodeGenerator.getCode(acceptor); if (code != null) code.toXML(xml); }
		{ ImCode code = compiler.imcode.CodeGenerator.getCode(acceptor); if (code != null && code.linearCode != null) code.linearCode.toXML(xml); }
	...
	public void visit(AbsExprName acceptor) {
		...
		if (code != null && code.linearCode != null) code.linearCode.toXML(xml); }
		xml.println("</absnode>");
	}
	...
	public void visit(AbsFunDecl acceptor) {
		...
		{ SemType type = TypeResolver.getType(acceptor); if (type != null) type.toXML(xml); }
		{ Frame frame = FrameResolver.getFrame(acceptor); if (frame != null) frame.toXML(xml); }
		{ ImCode code = compiler.imcode.CodeGenerator.getCode(acceptor); if (code != null) code.toXML(xml); }
		xml.println("</absnode>");
	}
	...
	public void visit(AbsVarDecl acceptor) {
		...
		acceptor.type.accept(this);
		{ SemType type = TypeResolver.getType(acceptor); if (type != null) type.toXML(xml); }
		{ Access access = FrameResolver.getAccess(acceptor); if (access != null) access.toXML(xml); }
		xml.println("</absnode>");
	}
