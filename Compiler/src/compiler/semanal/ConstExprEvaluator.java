...
public class ConstExprEvaluator implements Visitor {
	 ...
	 * @param value Vrednost konstantnega celostevilcnega izraza.
	 */
	public static void setValue(AbsTree absNode, Integer value) {
		if (values.get(absNode) != null) Report.error("Internal error.", 1);
	 ...
	 * 
	 * @param absNode Vozlisce abstraktnega sintaksnega drevesa.
	 * @return Vrednost konstantnega celostevilcnega izraza ali <code>null</code>, ce vrednost ne more biti dolocena.
	 */
	...
	public void visit(AbsBinExpr acceptor) {
		...
		if ((fstValue != null) && (sndValue != null)) {
			...
			case AbsBinExpr.DIV:
				if (sndValue == 0)
					Report.warning("Cannot divide with 0.", acceptor.getPosition());
				else
					setValue(acceptor, fstValue / sndValue);
				break;
			case AbsBinExpr.MOD:
